...
export default {
    ...
    raycast(body, layer, { raylength = 30, precision = 0, steepness = 1}) {//the ray parameters and length
        const {x, y, width, halfHeight } = body;

        this.bodyPositionDifferenceX += body.x - body.prev.x;//absolute value of position  
